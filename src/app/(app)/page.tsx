  ...
  return (
    <div className="p-4 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="p-3">
          <p className="text-xs text-[var(--text-muted)]">⚡ Pay in 3</p>
        </div>
        <div className="p-3">
          <p className="text-xs text-[var(--text-muted)]">🔒 Escrow protected</p>
        </div>
        <div className="p-3">
          <p className="text-xs text-[var(--text-muted)]">📡 HCS logged</p>
        </div>
      </div>
    </div>
  );
